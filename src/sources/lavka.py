"""
Скрейпер для сервиса Яндекс.Лавка (lavka.yandex.ru)
"""
import re
import logging
...
class LavkaScraper(BaseScraper):
        ...
        try:
            ...
            if address_input:
                ...
                suggestion_selectors = [
                    ...
                    '[data-testid="address-suggestion"]', '.suggestion'
                ]
            ...
            if not catalog_loaded:
                ...
                await self.page.wait_for_selector('img[src*="product"], .product, .item', timeout=15000)
    ...
    async def get_categories(self) -> List[str]:
        ...
        try:
            ...
            for selector in category_selectors:
                try:
                    ...
                    for elem in elements:
                        ...
                        if text and any(keyword in text.lower() for keyword in ['готов', 'кулинар', 'салат', 'суп', 'блюд', 'еда']):
                            categories.append({
                                'name': text.strip(),
            ...
            return ['Готовая еда', 'Кулинария', 'Салаты', 'Супы', 'Горячие блюда', 'Готовые блюда']
    ...
    async def scrape_product_page(self, url: str) -> Optional[ScrapedProduct]:
        ...
        try:
            ...
            if not page_loaded:
                ...
                await self.page.wait_for_selector('img, .product, .item, h1', timeout=15000)
            ...
            composition_selectors = [
                ...
                '[data-testid="composition"]', '.composition-text'
            ]
            ...
            weight_selectors = [
                ...
                '[data-testid="weight"]', '.weight-value'
            ]
